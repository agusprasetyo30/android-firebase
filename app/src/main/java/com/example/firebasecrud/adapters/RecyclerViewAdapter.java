...
import com.example.firebasecrud.UpdateData;
import com.example.firebasecrud.models.Data_mahasiswa;
//import com.google.firebase.database.core.Context;

import java.util.ArrayList;

//Class Adapter ini Digunakan Untuk Mengatur Bagaimana Data akan Ditampilkan//Class Adapter ini Digunakan Untuk Mengatur Bagaimana Data akan Ditampilkan
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>{
	...
	public RecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
		...
		View V = LayoutInflater.from(viewGroup.getContext())
			.inflate(R.layout.view_design, viewGroup, false);
